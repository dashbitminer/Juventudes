...
class PaisPoblacionBeneficiada extends Model
{
    use HasFactory;
    use SoftDeletes;
    use Userstamps;
    ...
    public function poblacionBeneficiada()
    {
        return $this->belongsTo(PoblacionBeneficiada::class, 'poblacion_beneficiada_id');
    }
}
