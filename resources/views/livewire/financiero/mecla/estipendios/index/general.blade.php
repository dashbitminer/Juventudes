                                ...
                                <tr wire:key='rand-{{ $estipendio->id }}'>
                                    ...
                                    <td
                                        ...
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            <a href="{{ route('estipendios.mecla.revisar', [$pais,$proyecto,$cohorte,$estipendio->id]) }}"
                                                wire:navigate class="text-indigo-600 hover:text-indigo-900">Revisar</a>
                                            @else
                                            <a href="{{ route('estipendios.mecla.revisar', [$pais,$proyecto,$cohorte,$estipendio->id]) }}"
                                                wire:navigate class="text-indigo-600 hover:text-indigo-900">Ver</a>
                                            @endif
                                        </div>
