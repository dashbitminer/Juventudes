            ...
            <div role="tabpanels" class="bg-white border border-gray-200 rounded-b-lg rounded-tr-lg">
                ...
                <section x-show="isSelected($id('tab', whichChild($el, $el.parentElement)))"
                    ...
                    <div class="">
                        ...
                        <livewire:financiero.admin.participante.index.table :$filters
                ...
                <section x-show="isSelected($id('tab', whichChild($el, $el.parentElement)))"
                    ...
                    <livewire:financiero.admin.participante.index.participantes :$filters
                        :cohortePaisProyecto="$selectedCohortePaisProyecto" :paisProyecto="$selectedPaisProyecto" />
