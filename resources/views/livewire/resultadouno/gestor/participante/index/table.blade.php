                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr wire:key='rand-{{ $participante->id }}'>
                            ...
                            <td class="px-3 py-5 text-sm text-gray-500 whitespace-nowrap">
                                {{ $participante->documento_identidad }}</td>
                            <td class="px-3 py-5 text-sm text-gray-500 whitespace-nowrap">
                                @if ($participante->lastEstado)
                                        <div
                                            role="button"
                                ...
                                @else
                                        <div
                                            role="button"
                                            class="inline-flex items-center gap-1 py-1 pl-2 pr-1 text-xs font-medium text-gray-600 bg-gray-100 rounded-full cursor-pointer">
                                            <div> Documentación pendiente
                                            </div>
                                            <x-dynamic-component component="icon.pencil-square" />
                                        </div>
                                @endif
