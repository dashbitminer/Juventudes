                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    <div class="px-4 py-6 sm:p-8">
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="px-4">
                                    <div class="max-w-2xl space-y-10">
                                        <fieldset>
                                            ...
                                            <x-input-error :messages="$errors->get('form.categoriaSelected')" class="mt-2" />
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <x-text-input wire:model.live="form.monto"
                                        ...
                                        />
                                        <x-input-error
                                            :messages="$errors->get('form.monto')"
                                            class="mt-2" aria-live="assertive" />
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                ...
                                <div class="mt-2">
                                    <x-forms.single-select name="metodoValoracionSelected" wire:model='form.metodoValoracionSelected'
                                        ...
                                        />
                                        <x-input-error :messages="$errors->get('form.metodoValoracionSelected')"
                                            class="mt-2" aria-live="assertive" />
                                </div>
                            </div>
                                ...
                                <div class="px-4">
                                    <div class="max-w-2xl space-y-10">
                                        <fieldset>
                                            ...
                                            <x-input-error :messages="$errors->get('form.actividadSelected')" class="mt-2" />
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="sm:col-span-3">
                                <x-input-label for="registrado_contablemente">{{ __('Ya se encuentra registrado contablemente:') }}
                                    <x-required-label />
                                </x-input-label>
                                <div class="flex items-center mt-2 space-x-4">
                                    <label class="flex items-center">
                                        <input type="radio" name="registrado_contablemente" value="1" wire:model="form.registrado_contablemente" class="text-indigo-600 border-gray-300 focus:ring-indigo-500">
                                        <span class="ml-2">{{ __('Si') }}</span>
                                    </label>
                                    <label class="flex items-center">
                                        <input type="radio" name="registrado_contablemente" value="0" wire:model="form.registrado_contablemente" class="text-indigo-600 border-gray-300 focus:ring-indigo-500">
                                        <span class="ml-2">{{ __('No') }}</span>
                                    </label>
                                </div>
                                <x-input-error :messages="$errors->get('form.registrado_contablemente')" class="mt-2" />
                            </div>
                                    ...
                                    <div class="max-w-2xl space-y-10">
                                        <fieldset>
                                            <div class="flex flex-wrap gap-4 mt-6">
                                                ...
                                                <div class="relative flex flex-col w-full gap-y-3" x-data="{ isChecked: @json(in_array($key, $form->resultadoSelected)) }">
                                                    <!-- Checkbox -->
                                                    ...
                                                    <!-- Input de porcentaje -->
                                                    <div x-show="isChecked" class="flex items-center mt-3 gap-x-2">
                                                        <input
                                                            type="number"
                                                            min="0"
                                                            max="100"
                                                        ...
                                                        <x-input-error :messages="$errors->get('form.resultadoPorcentajes.{{$key}}')" class="mt-2" />
                                                    </div>
                                                </div>

                                                @endforeach
                                            </div>
                                            <x-input-error :messages="$errors->get('form.resultadoSelected')" class="mt-2" />
                                        </fieldset>
                                    </div>
                                </div>
                            </div>
