...
<div>
                ...
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div class="col-span-full">
                            <label for="website"
                                class="block text-sm font-medium leading-6 text-gray-900">Origen de la gestión de la Alianza:
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                <div class="px-4 py-6 sm:p-8">
                    <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <x-input-label for="departamentoSelected">{{ __('Correo electronico del contacto:')
                                }}
                                <x-required-label />
                            </x-input-label>
                            <div class="mt-2">
    ...
    <livewire:resultadotres.gestor.visualizador.forms.comentario :model="$alianza"  />
    <livewire:resultadotres.gestor.visualizador.estado-registro.index :model="$alianza" />
</div>
