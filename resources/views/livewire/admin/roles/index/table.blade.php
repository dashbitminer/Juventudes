<div class="flow-root mt-8">
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    <tr>
                        ...
                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">
                            <x-participante.index.sortable column="roles" :$sortCol :$sortAsc>
                                <div class="whitespace-nowrap">Rol</div>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr wire:key='rand-{{ $rol->id }}'>
                            <td class="p-3 text-sm whitespace-nowrap">
                                <div class="flex items-center">
                                    <input wire:model="selectedIds" value="{{ $rol->id }}"
                            ...
                            <td class="py-5 pl-4 pr-3 text-sm whitespace-nowrap sm:pl-0">
                                <div class="flex items-center">
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">{{ $rol->name }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="relative py-5 pl-3 pr-4 text-sm font-medium text-right whitespace-nowrap sm:pr-0">
                                <x-admin.roles.user-row-dropdown :$rol wire:key='row-{{ $rol->id}}' />
                            </td>
                        </tr>
    ...
    <div class="flex items-center justify-between pt-4">
        ...
        {{ $roles->links('livewire.resultadouno.gestor.participante.index.pagination') }}
    </div>
