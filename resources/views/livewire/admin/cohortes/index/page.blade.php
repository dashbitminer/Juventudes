...
<x-slot:header>
    <h2 class="text-xl font-semibold leading-tight text-gray-800">
        {{ __('Configuración de Cohortes - Proyecto') }} {{ $proyecto->nombre }}
    </h2>
    <small>Cohortes</small>
</x-slot>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Cohortes</h1>
                    <p class="mt-2 text-sm text-gray-700">
                        Lista de todos las cohortes del proyecto.</p>
                </div>
            ...
            <livewire:admin.cohortes.index.table :$proyecto>

        </div>


        <livewire:admin.cohortes.create.page :$proyecto />
        <livewire:admin.cohortes.edit.page />
        <livewire:admin.cohortes.create.perfiles />
        <livewire:admin.cohortes.create.rango-edades />
    </div>
