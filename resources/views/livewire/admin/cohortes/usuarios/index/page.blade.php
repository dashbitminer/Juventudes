...
<x-slot:header>
    <h2 class="flex gap-2 text-xl font-semibold leading-tight text-gray-800">
        <a href="#">
            {{ __('Configuración de Cohortes - Proyecto Jóvenes con propósito - Cohorte: ') . $cohortePaisProyecto->cohorte->nombre . ' - Usuarios'  }}
        </a>
    </h2>
</x-slot>
...
<div class="py-6 overflow-hidden bg-white shadow-sm sm:rounded-lg">
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">
                    Consulta la lista de usuarios registrados en la cohorte {{ $cohortePaisProyecto->cohorte->nombre }}.</p>
            </div>
        ...
        <livewire:admin.cohortes.usuarios.index.table :$filters :$cohortePaisProyecto/>

    </div>

    <livewire:admin.cohortes.usuarios.create.page :$cohortePaisProyecto />
    {{--<livewire:admin.cohortes.usuarios.edit.page />--}}
</div>
