                            ...
                            <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-indigo-300">
                                        Completa el formulario para agregar un usuario a la cohorte.
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="px-4 space-y-2 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 sm:px-6 sm:py-5">
                                        <div class="col-span-full mb-1">
                                            <x-input-label for="Role">
                                                {{ __('Seleccione el Rol del usuario que desea agregar:') }}
                                                <x-required-label />
                                            </x-input-label>
                                            <div class="mt-2">
                                                <x-forms.single-select name="role"
                                                    wire:model.live='role'
                                                    :options="$roles" selected="Seleccione un Rol"
                                                    @class([ 
                                                        'block w-full mt-1','border-2 border-red-500' => $errors->has('role')
                                                    ])
                                                />
                                        ...
                                        <div x-show="$wire.role == 2" class="col-span-full mb-1">
                                            <x-input-label for="Role">
                                                {{ __('Seleccione el Coordinador de los Gestores:') }}
                                                <x-required-label />
                                            </x-input-label>
                                            <div class="mt-2">
                                                <x-forms.single-select name="coordinador"
                                                    wire:model='coordinador'
                                                    :options="$coordinadores" selected="Seleccione un coordinador"
                                                    @class([ 
                                                        'block w-full mt-1','border-2 border-red-500' => $errors->has('coordinador')
                                                    ])
                                                />
                                                <x-input-error :messages="$errors->get('coordinador')"
                                                    class="mt-2" aria-live="assertive" />
                                            </div>
                                        </div>

                                        <div class="col-span-full mb-1" x-show="$wire.role !== null && $wire.role !== ''">
                                            <div class="mt-2">
                                                ...
                                                <x-text-input  id="search"
                                                    ...
                                                    @class([
                                                        'block w-full mt-1 mb-2'
                                                    ])
                                               />
                                                <div class="mt-2"></div><div class="mt-2"></div>
                                                <x-input-label for="usuarios" class="mt-2">
                                                    {{ __('Seleccione los usuarios que desea agregar:') }}
                                                    <x-required-label />
                                                </x-input-label>
                                                ...
                                                <x-input-error :messages="$errors->get('usuarios')"
                                                    class="mt-2" aria-live="assertive" />
                                            </div>
                                        </div>
                                    </div>
