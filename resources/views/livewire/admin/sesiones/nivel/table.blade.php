<div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="bg-white" wire:key='rand-{{ $model->id }}'>
                                ...
                                <td class="px-3 py-4 text-sm text-left text-gray-500">
                                    ...
                                    <span class="text-italyc">Nivel {{ $model->nivel ?? '' }}</span>
                                </td>
                                <td class="px-3 py-4 text-sm text-left text-gray-500">
                                    {{ $model->comentario ?? '' }}
                                </td>
                                ...
                                <td class="relative py-5 pr-4 pl-3 text-sm font-medium text-right whitespace-nowrap sm:pr-0">
                                    <x-admin.sesiones.user-row-dropdown :model="$model" wire:key='nivel-{{ $model->id }}' />
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
    ...
    <x-admin.sesiones.nivel.drawer :$niveles />
