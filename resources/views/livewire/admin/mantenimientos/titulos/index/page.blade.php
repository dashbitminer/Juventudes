    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Titulos</h1>
                <p class="mt-2 text-sm text-gray-700">
                    Lista de todos los titulos en su cuenta incluyendo su nombre y fecha de creación.</p>
            </div>
        ...
        {{-- <livewire:admin.mantenimientos.titulos.index.table> --}}

    </div>

    {{-- <x-admin.roles.drawer :$permisos :$categorias/> --}}
    {{-- <x-admin.titulos.drawer /> --}}
