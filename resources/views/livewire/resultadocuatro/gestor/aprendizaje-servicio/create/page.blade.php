                ...
                <div class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
                    <div class="px-4 py-6 sm:p-8">
                        <h4 class="font-semibold leading-tight text-gray-800">
                            Recuerda que este formulario debe ser llenado para registrar la ficha de aprendizaje de servicio del participante
                        </h4>
                    </div>
                </div>
                        ...
                        <div class="px-4 py-6 sm:p-8">
                            <div class="max-w-2xl space-y-10">
                                    ...
                                    <div class="mt-2">
                                        <div class="px-4 py-3">
                                            <div class="max-w-2xl space-y-10">
                                                ...
                                                <x-input-error
                                                    :messages="$errors->get('form.temasSelected')"
                                                    class="mt-2" aria-live="assertive" />
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="titulo_contribucion_cambio" id="titulo_contribucion_cambio" wire:model='form.titulo_contribucion_cambio' rows="3"
                                        @class([
                                            'block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
                                        ...
                                        <x-input-error :messages="$errors->get('form.titulo_contribucion_cambio')" class="mt-2"
                                                aria-live="assertive" />
                                    </div>
                                </div>
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="objetivo_contribucion_cambio" id="objetivo_contribucion_cambio" wire:model='form.objetivo_contribucion_cambio' rows="3"
                                        @class([
                                            'block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
                                        ...
                                        <x-input-error :messages="$errors->get('form.objetivo_contribucion_cambio')" class="mt-2"
                                                aria-live="assertive" />
                                    </div>
                                </div>
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="acciones_contribucion_cambio" id="acciones_contribucion_cambio" wire:model='form.acciones_contribucion_cambio' rows="3"
                                        @class([
                                            'block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
                                        ...
                                        <x-input-error :messages="$errors->get('form.acciones_contribucion_cambio')" class="mt-2"
                                                aria-live="assertive" />
                                    </div>
                                </div>
                                        ...
                                        <div class="sm:col-span-1">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @else
                                                    ...
                                                    />
                                                @endif
                                            <x-input-error :messages="$errors->get('form.fecha_inicio_cambio')" class="mt-2" />
                                            </div>
                                        </div>
                                        <div class="sm:col-span-1">
                                            ...
                                            <div class="mt-2">
                                                ...
                                                @else
                                                    ...
                                                    />
                                                @endif
                                                <x-input-error :messages="$errors->get('form.fecha_fin_cambio')" class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                                        <div class="sm:col-span-1">
                                            ...
                                            <div class="mt-2">
                                                    ...
                                                    />
                                            <x-input-error :messages="$errors->get('form.promedio_aprendizaje')" class="mt-2" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="otros_comentarios" id="otros_comentarios" wire:model='form.otros_comentarios' rows="3"
                                        @class([
                                            'block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
                                        ...
                                        <x-input-error :messages="$errors->get('form.otros_comentarios')" class="mt-2"
                                                aria-live="assertive" />
                                    </div>
                                </div>
                            </div>
