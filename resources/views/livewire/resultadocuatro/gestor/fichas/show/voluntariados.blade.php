<div>
    <h2 class="font-semibold text-gray-900 text-base/7">Ficha de Voluntariado</h2>
    ...
    <dl class="mt-6 space-y-6 border-t border-gray-200 divide-y divide-gray-100 text-sm/6">
            ...
            <div wire:key="$empleo->id" class="pt-6 sm:flex">
                ...
                <dd class="flex justify-between mt-1 gap-x-6 sm:mt-0 sm:flex-auto">
                    ...
                    <div class="flex gap-x-4">
                        ...
                        <button type="button"
                            wire:click="delete({{ $voluntariado->id }})"
                        ...
                        <a rol="button" href="{{ route('ficha.voluntariado.edit', [$pais, $proyecto, $cohorte, $participante, $voluntariado->id]) }}"
        ...
        <div class="flex pt-6 border-t border-gray-100">
            <a rol="button" href="{{ route('ficha.voluntariado.create', [$pais, $proyecto, $cohorte, $participante]) }}"
