...
<div>
    ...
    <livewire:resultadocuatro.gestor.visualizador.forms.comentario :$pais :$proyecto :model="$servicio_comunitario"  />
    <livewire:resultadocuatro.gestor.visualizador.estado-registro.index :model="$servicio_comunitario" />
</div>
