                        ...
                        <div class="px-4 py-6 sm:p-8">
                            <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-4">
                                    ...
                                    <div class="mt-2">
                                        <select name="perfiles" id="areaIntervencionSelected"
                                            wire:model.live="form.areaIntervencionSelected" x-on:change="const selectedOption = event.target.options[event.target.selectedIndex];
                                            const areaOption = selectedOption.getAttribute('data-area-options');
                                            $wire.set('form.areaIntervencionSelectedPivot', areaOption);"
                                            @class([ 'block w-full rounded-md sm:text-sm sm:leading-6 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm'
                                            , 'border-2 border-red-500'=> $errors->has('form.areaIntervencionSelected')
                                            ])
                                            >
                                        ...
                                        <x-input-error :messages="$errors->get('form.areaIntervencionSelected')" class="mt-2" aria-live="assertive" />
                                    </div>
                                </div>
                                ...
                                <div class="col-span-full" x-show="$wire.form.areaIntervencionSelected == {{ App\Models\AreaIntervencion::OTRA }}">
                                    ...
                                    <div class="mt-2">
                                        <textarea name="otraAreaIntervencion" id="otraAreaIntervencion" wire:model='form.otraAreaIntervencion' rows="3"
                                            @class([
                                            'block w-full rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6',
                                            'border-0 border-slate-300'=> $errors->missing('form.otraAreaIntervencion'),
                                            'border-2 border-red-500' => $errors->has('form.otraAreaIntervencion'),
                                        //   'disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none' => $form->readonly,
                                        ])></textarea>
                                        <x-input-error :messages="$errors->get('form.otraAreaIntervencion')" class="mt-2"
                                                aria-live="assertive" />
                                    </div>
                                </div>
