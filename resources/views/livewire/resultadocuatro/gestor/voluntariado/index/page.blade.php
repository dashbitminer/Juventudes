        ...
        <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    <h1 class="text-base font-semibold leading-6 text-gray-900">Voluntariado</h1>
                    <p class="mt-2 text-sm text-gray-700">
                        Lista de todos los participantes en su cuenta incluyendo su nombre, ciudad, DNI, estado y
                        fecha de registro.</p>
                </div>
            ...
            <livewire:resultadocuatro.gestor.voluntariado.index.table :$pais :$proyecto />
        </div>
    </div>
