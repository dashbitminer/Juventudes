    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="text-base font-semibold leading-6 text-gray-900">Lista de Ficha de Empleos</h1>
                {{-- <p class="mt-2 text-sm text-gray-700">
                    Lista de fichas
                </p> --}}
            </div>
            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                <a href="{{ route('empleo.create', [$pais, $proyecto, $cohorte, $participante]) }}"
                    role="button"
        ...
        <livewire:resultadocuatro.gestor.empleo.index.table :$pais :$proyecto :$cohorte :$participante />
    </div>
</div>
