        ...
        <div class="overflow-hidden absolute inset-0">
            <div class="flex fixed inset-y-0 right-0 pl-10 max-w-full pointer-events-none sm:pl-16">
                ...
                <div x-show="$wire.openDrawerEdit"
                    ...
                    <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl" wire:submit='editSocio'>
                        <div class="overflow-y-auto flex-1 h-0">
                            <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                                <div class="flex justify-between items-center">
                                    <h2 class="text-base font-semibold text-white" id="slide-over-title">Editar Socio
                                    </h2>
                                ...
                                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                    <div class="pt-6 pb-5 space-y-6">
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <x-text-input wire:model="nombre" id="nombre" name="nombre"
                                                    type="text"
                                                    @class([ 'block w-full mt-1','border-2 border-red-500' => $errors->has('nombre')])
                                                    />
                                            </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-2">
                                                <flux:select variant="listbox" id="pais" name="pais" wire:model='pais_id'
                                                    placeholder="Seleccione un pais" class="text-indigo-900 border-indigo-500 focus:ring-indigo-500">
                                                    @foreach ($paises as $pais)
                                                        <flux:option value="{{ $pais->id }}">{{ $pais->nombre }}</flux:option>
                                                    @endforeach
                                                </flux:select>
                                            </div>
