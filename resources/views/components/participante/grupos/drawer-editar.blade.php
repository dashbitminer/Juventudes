...
<div @keydown.window.escape="$wire.openDrawerEditar = false" x-cloak x-show="$wire.openDrawerEditar" class="relative z-10"
    ...
    <div class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
            <div class="fixed inset-y-0 right-0 flex max-w-full pl-10 pointer-events-none sm:pl-16">
                ...
                <div x-show="$wire.openDrawerEditar"
                    ...
                    @click.away="$wire.openDrawerEditar = false"
                    >
                    <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl" wire:submit='editarGrupo'>
                        <div class="flex-1 h-0 overflow-y-auto">
                            <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <h2 class="text-base font-semibold leading-6 text-white" id="slide-over-title">Editar grupo</h2>
                                    <div class="flex items-center ml-3 h-7">
                                        <button type="button"
                                            ...
                                            x-on:click="$wire.openDrawerEditar = false"
                                            >
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-indigo-300">Edite la configuracion del grupo</p>
                                </div>
                            </div>
                        ...
                        <div class="flex justify-end flex-shrink-0 px-4 py-4">
                            <button type="button"
                                ...
                                @click="$wire.openDrawerEditar = false">Cancelar</button>
                            <button type="submit"
                                class="inline-flex justify-center px-3 py-2 ml-4 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Actualizar</button>
                        </div>
                    </form>
                </div>
