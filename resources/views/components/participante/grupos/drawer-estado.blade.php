@props(['lista' => [], 'cohorte', 'paisProyecto', 'estados', 'cohortePaisProyecto ','categorias', 'razones', 'selectedRazon'])

<div @keydown.window.escape="$wire.openDrawerEstado = false" x-cloak x-show="$wire.openDrawerEstado" class="relative z-10"
    ...
    <div class="fixed inset-0 overflow-hidden">
        <div class="absolute inset-0 overflow-hidden">
            <div class="fixed inset-y-0 right-0 flex max-w-full pl-10 pointer-events-none sm:pl-16">
                ...
                <div x-show="$wire.openDrawerEstado"
                    ...
                    @click.away="$wire.openDrawerEstado = false"
                    >
                    <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl" wire:submit='cambiarEstadoParticipante'>
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex items-center ml-3 h-7">
                                        <button type="button"
                                            ...
                                            @click="$wire.openDrawerEstado = false"
                                            >
                                ...
                                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                    <div class="pt-6 pb-5 space-y-6">
                                            ...
                                            <div class="mt-2">
                                                <x-text-input wire:model="fechaCambioEstado" id="fechaCambioEstado"
                                                    ...
                                                    @class([
                                                        ...
                                                        'block w-full mt-1','border-2 border-red-500' => $errors->has('fechaCambioEstado')
                                                    ])
                                                />
                                        ...
                                        <div x-show="$wire.selectedEstado == 3 || $wire.selectedEstado == 5">
                                            ...
                                            <div class="mt-2">
                                                <x-forms.single-select name="categorias" wire:model.live='selectedCategoria'
                                                    id="categorias" :options="$categorias" selected="Seleccione una categoria"
                                                    @class([
                                        ...
                                        <div x-show="$wire.selectedEstado == 3 || $wire.selectedEstado == 4 || $wire.selectedEstado == 5">
                                            ...
                                            <div class="mt-2">
                                                <x-forms.single-select name="razones" wire:model.live='selectedRazon'
                                                    id="razones" :options="$razones" selected="Seleccione una categoria"
                                                    @class([
                                            ...
                                            <div class="mt-2">
                                                ...
                                                {{-- @if($counter > 0)
                                                    <div class="flex gap-4 mt-4">
                                                        ...
                                                        <span class="text-red-500">Participantes que se encuentren asignados a un grupo seran reasignados al nuevo grupo.</span>
                                                    </div>
                                                @endif --}}
                        ...
                        <div class="flex justify-end flex-shrink-0 px-4 py-4">
                            <button type="button"
                                ...
                                @click="$wire.openDrawerEstado = false">Cancelar</button>
                            <button type="submit"
                                class="inline-flex justify-center px-3 py-2 ml-4 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cambiar estado</button>
                        </div>
                    </form>
                </div>
