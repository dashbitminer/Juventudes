...
<div @keydown.window.escape="$wire.openDrawerView = false" x-cloak x-show="$wire.openDrawerView" class="relative z-30"
                    ...
                    <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl"
                        ...
                        <div class="flex justify-end px-4 py-4 shrink-0">
                            <button type="button"
                                ...
                                @click="$wire.openDrawerView = false">Cerrar</button>
