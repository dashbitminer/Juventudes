    ...
    <div class="fixed inset-0 overflow-hidden">
      <div class="absolute inset-0 overflow-hidden">
        <div class="fixed inset-y-0 right-0 flex max-w-full pl-10 pointer-events-none sm:pl-16">
            ...
            >
            <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl" wire:submit='crearGrupo'>
              <div class="flex-1 h-0 overflow-y-auto">
                <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                  <div class="flex items-center justify-between">
                    <h2 class="text-base font-semibold text-white" id="slide-over-title">Nuevo Grupo</h2>
                  ...
                  <div class="px-4 divide-y divide-gray-200 sm:px-6">
                    <div class="pt-6 pb-5 space-y-6">
                      <div>
                        ...
                        <div class="mt-2">
                            <input id="nombre" name="nombre" type="text" wire:model='nombre'
                      ...
                      {{-- <div>
                        ...
                        <div class="mt-2">
                            <input id="monto" name="monto" type="number" step="0.01" wire:model='monto'
                                @class([ 'border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm'
                                , 'disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none'
                                , 'block w-full mt-1' ,'border-2 border-red-500'=> $errors->has('monto'),
                            ]) />
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                ...
                                <div class="grid grid-cols-1">
                                    ...
                                    <div class="flex items-center justify-between p-2 bg-white rounded-md shadow-sm"
                                        ...
                                        <span class="text-gray-900">
                                            ...
                                            <span
                                                ...
                                                {{ $participante->bancarizacionGrupos->where('pivot.active_at', '!=', null)->first()->nombre ?? '' }}
                                            </span>
                                            @endif
                                    ...
                                    {{-- <div
                                        x-show="!$wire.lista.length && $wire.openDrawer"
              ...
              <div class="flex justify-end px-4 py-4 shrink-0">
                ...
                @click="$wire.openDrawer = false"
                >Cancelar</button>
                <button type="submit" class="inline-flex justify-center px-3 py-2 ml-4 text-sm font-semibold text-white bg-indigo-600 rounded-md shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Crear
