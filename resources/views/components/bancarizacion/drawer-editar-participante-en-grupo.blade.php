            ...
            <div class="fixed inset-y-0 right-0 flex max-w-full pl-10 pointer-events-none sm:pl-16">
                ...
                <div x-show="$wire.openEditDrawer"
                    ...
                    <form class="flex flex-col h-full bg-white divide-y divide-gray-200 shadow-xl"
                        wire:submit='editarParticipante'>
                        <div class="flex-1 h-0 overflow-y-auto">
                            <div class="px-4 py-6 bg-indigo-700 sm:px-6">
                                <div class="flex items-center justify-between">
                                    <h2 class="text-base font-semibold text-white" id="slide-over-title">Editar monto
                                        para participantes</h2>
                                ...
                                <div class="mt-1">
                                    <p class="text-sm text-indigo-300">Editar el monto para los participantes
                                        seleccionados.</p>
                                </div>
                            </div>
                            <div class="flex flex-col justify-between flex-1">
                                <div class="px-4 divide-y divide-gray-200 sm:px-6">
                                    <div class="pt-6 pb-5 space-y-6">
                                        ...
                                        <div>
                                            <h3 class="text-sm font-medium leading-6 text-gray-900">Participantes
                                                seleccionados: </h3>
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <div class="grid grid-cols-1">
                                                    ...
                                                    <div class="flex items-center justify-between p-2 bg-white rounded-md shadow-sm"
                                                        wire:key='grupo-participante-{{ $participante->id }}'>
                                                        <span class="text-gray-900">
                                                            {{ $participante->full_name }} <span>- {{
                                                                $participante->bancarizacionGrupos()->wherePivot('active_at',
                                                                '!=', null)->first()->nombre }}</span>


                                                            @if($participante->bancarizacionGrupos()->wherePivot('active_at',
                                                            '!=', null)->first()->pivot->monto)
                                                            @php $counter++; @endphp
                                                            <span
                                                                class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-500 text-white">
                                                                ({{
                                                                number_format($participante->bancarizacionGrupos()->wherePivot('active_at',
                                                                '!=', null)->first()->pivot->monto, 2) }})
                                                            </span>
                                                            @else
                                                            ({{
                                                            number_format($participante->bancarizacionGrupos()->wherePivot('active_at',
                                                ...
                                                <div class="flex gap-4 mt-4">
                                                    ...
                                                    <span class="text-red-500">Participantes que ya tienen asignado un
                                                        monto serán actualizados sin afectar el monto asignado al grupo
                                                        en general.</span>
                                                </div>
                                                @endif
                                            </div>
